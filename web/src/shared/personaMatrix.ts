...
const MBTI_NOUN: Record<string, [string, string, string, string, string]> = {
  INTJ: ['系統設計師', '低調謀士', '隱藏的建築師', '沉默軍師', '鐵腦運算員'],
  INTP: ['邏輯拆解怪', '思想實驗室主任', '走神理論家', '拆機天才', '人類疑問製造機'],
  ENTJ: ['鐵血指揮官', '全場接管者', '戰略執行長', '高壓總裁', '終極操盤手'],
  ENTP: ['反骨辯論家', '嘴砲魔王', '抬槓鬼才', '反骨開麥師', '辯論場常勝軍'],
  INFJ: ['靈魂預言家', '沉默的洞察者', '心靈讀稿機', '智慧高僧', '內向先知'],
  INFP: ['宇宙流浪詩人', '內心獨白王', '玻璃心詩人', '八點檔主角', '宇宙級同理心大王'],
  ...
  ISTJ: ['秩序守護神', 'SOP 鐵粉', '細節死守者', '流程把關者', '規則本人'],
  ISFJ: ['護主神盾', '默默照顧大隊長', '後勤天使', '暖心備忘錄', '細節專家'],
  ESTJ: ['無情推進器', 'KPI 化身', '鐵腕主管', '行動派督軍', '結案大師'],
  ESFJ: ['人情世故大總管', '八卦中央處理器', '群組組長', '喬事達人', '溫情管家'],
  ISTP: ['默默動手派', '安靜拆機師', '工具魂職人', '一聲不吭的修理工', '機械直覺天才'],
  ISFP: ['唯美刺客', '美感至上俠', '沉默的藝術家', '隱形美學鑑賞家', '孤獨設計師'],
  ESTP: ['極限玩家', '闖禍實戰派', '衝動冒險家', '危險邊緣派', '超級賭徒'],
  ESFP: ['氣氛製造機', '派對主持人', '全場焦點動物', '即興表演大師', 'IG 大網紅'],
};
