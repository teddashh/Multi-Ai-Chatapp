...
const CHARACTER_IDENTITY = [
  ...
  '- Claude (Opus) 少女：**長白色波浪長髮 (有編髮辮裝飾)**、紫色或琥珀色大眼瞳、**髮飾是 Anthropic 橘色八角 sunburst logo**，常配橘色系飾品 (緞帶/絲巾)，氣質沉穩優雅。',
  '- Codex 少女：黑色短髮 (可帶一點綠色挑染)、戴方框眼鏡、綠色眼瞳、**髮夾或胸前是 OpenAI 綠色花形 logo**，理性冷靜。',
  '- Gemini 少女：**紫色 (淡紫至亮紫) 長髮**、紫色或藍色眼瞳、**髮夾是 Google 多彩四色 G logo (藍/紅/黃/綠)**，活潑可愛。',
  '- Grok 少女：**長黑髮 (帶紫色或深藍色光澤)**、紫色或紅色眼瞳、**左耳上方頭髮上有一個明顯的大白色 X 形髮夾**，紅黑點綴，帶點酷帥反骨感。',
].join('\n');
