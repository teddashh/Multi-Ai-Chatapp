...
// Tiny .env loader so XAI_API_KEY (and any other secret in server/.env)
// is available when this script runs from the CLI. Quietly skip if no
// .env exists — the production systemd unit feeds env via
// EnvironmentFile, and that path doesn't go through this loader.
